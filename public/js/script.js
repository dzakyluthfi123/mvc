document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.tombolTambahdata').forEach(function(element) {
        element.addEventListener('click', function() {
            ...
            if (form) {
                form.action = 'http://localhost/mvcfix/public/mahasiswa/tambah'; // Ganti ke URL untuk menambah data
            }
    ...
    document.querySelectorAll('.tampilModalUbah').forEach(function(element) {
        element.addEventListener('click', function() {
            ...
            $.ajax({
                url: 'http://localhost/mvcfix/public/mahasiswa/getubah',
                data: { id: id },
                method: 'post',
                dataType: 'json',
                success: function(data) {
                    ...
                    var form = document.querySelector('#formMahasiswa');
                    if (form) {
                        form.action = 'http://localhost/mvcfix/public/mahasiswa/ubah'; // Ganti ke URL untuk ubah data
